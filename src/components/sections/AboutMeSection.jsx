...
export const AboutMeSection = () => {
  ...
  return (
    <section className="xl:h-full lg:h-full exactly-1024:h-fit pt-9 xl:mt-16 exactly-1024:mt-24 mb-16 flex flex-col " id="about-me-section">
      ...
      <div ref={ref} className="lg:w-[84%] md:h-[40rem] sm:h-[30rem] flex lg:justify-center md:justify-center sm:justify-start relative items-center md:mb-16 sm:mb-4">
        ...
        <div className="relative w-[78%] h-full grid grid-cols-2 gap-10 lg:left-36">
          <motion.div
            initial={{ left: '-8rem' }}
            animate={{ left: isInView ? '0' : '-8rem' }}
            transition={{ duration: 1 }}
            className="absolute lg:w-[49%] md:w-[59%] lg:h-[73%] bottom-16 font-second-font text-[black] card bg-[#fff] p-6 rounded-3xl -rotate-6 z-10 ">
            <div className="flex">
          ...
          <motion.div
            initial={{ right: '0' }}
            animate={{ right: isInView ? '11rem' : '0' }}
            transition={{ duration: 1 }}
            className="absolute lg:w-[45%] lg:h-[73%] md:h-[69%] sm:h-[64%] bottom-16 lg:right-44 md:right-[36px] sm:-right-8 md:top-40 sm:top-32 bg-[#0b0b0e]  p-6 rounded-3xl lg:rotate-12 sm:rotate-6  code-snippet">
      ...
      <motion.a
        ...
        transition={{ duration: 1 }}
        href="/pdf/cv_outmassint_hamza.pdf" target="_blank" className="max-w-fit font-second-font mt-8 self-center" rel="noreferrer">
