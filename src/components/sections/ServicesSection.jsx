...
export const ServicesSection = () => {
  return (
    <section className="xl:h-full lg:h-screen exactly-1024:h-fit pt-9" id="services-section">
      ...
      <div className="mt-14 lg:w-[70%] font-second-font">
        <h1 className="font-second-font text-4xl sm:text-xl">
          My <span className="text-main-color">Specializations</span>
        </h1>
