...
//           <img class="w-full px-2 cursor-pointer" src={Project1Img1} alt="Sunset in the mountains" onClick={handleModalToggle}/>
...
//           <img class="w-full px-2 cursor-pointer" src={Project2Img1} alt="Sunset in the mountains" />
//           <div class="px-2 pt-4 lg:mt-4 flex justify-between items-center">
//             <div>
...
//           <div className="flex justify-center items-center project-cart1 text-bg-color md:p-8 relative rounded-lg lg:w-[70%] lg:h-[70%] sm:w-[89%] sm:h-[37%] exactly-1024:h-[37%]">
...
//       {isModalOpen && (
//         <div className="fixed inset-0 bg-bg-color bg-opacity-50 flex items-center justify-center" onClick={handleModalToggle}>
//           <div className="flex justify-center items-center project-cart1 text-bg-color md:p-8 relative rounded-lg lg:w-[70%] lg:h-[70%] sm:w-[89%] sm:h-[37%] exactly-1024:h-[37%]" onClick={stopPropagation} style={{ overflow: 'hidden' }}>
//             {/* Apply overflow: hidden to the parent container */}
//             <Swiper navigation={true} modules={[Navigation]} className='w-full h-full'>
//               {/* Ensure the Swiper fills the parent container */}
//               <SwiperSlide className='bg-white'>
//                 Lorem ipsum dolor sit amet consectetur adipisicing elit. 
//                 Nesciunt eaque soluta officiis nobis aperiam quae accusantium deserunt iste quibusdam, 
//                 maiores aut obcaecati provident, fugit placeat. Qui minus explicabo quo similique.
//               </SwiperSlide>
//               <SwiperSlide>
//                 <img src={Project1Img1} alt="project image" className="rounded-md w-3/4"/>
//               </SwiperSlide>
