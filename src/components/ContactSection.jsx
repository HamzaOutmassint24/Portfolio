...
export const ContactSection = () => {
  return (
    <section className="xl:h-full lg:h-screen exactly-1024:h-fit pt-9 pb-44 lg:w-[87%]" id="contact-section">
      ...
      <div>
        <div className="flex flex-col mb-6">
          ...
          <a href="#" className="max-w-fit font-second-font">
            <button className="relative group p-2 px-12 bg-main-color transition-colors duration-300 rounded-full border-2 border-main-color">
              <div className="absolute top-2.5 left-3 h-5 w-5 bg-bg-color rounded-full group-hover:h-full group-hover:w-full group-hover:top-0 group-hover:left-0 transition-all duration-300 z-10"></div>
