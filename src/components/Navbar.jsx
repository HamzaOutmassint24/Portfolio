      ...
      <nav className="lg:hidden sm:flex justify-end relative top-10">
        ...
        >
          <ul className="mt-16 ml-24 max-h-96 flex flex-col justify-between">
            ...
            <li>
              <button onClick={() =>{scrollToSection('home'); setOpen(!open) } } className="text-fourth-color flex">
                <HouseDoor size={21} />
                <span className="ml-2">Home</span>
              </button>
            </li>
            <li>
              <button onClick={() =>{scrollToSection('about-me-section') ; setOpen(!open)} } className="text-fourth-color flex">
                <Person size={23} />
                <span className="ml-2">About</span>
              </button>
            </li>
            <li>
              <button onClick={() => scrollToSection("services")} className="text-fourth-color  flex">
                <MenuButton size={20} />
                <span className="ml-2">Services</span>
              </button>
            </li>
            <li>
              <button onClick={() => scrollToSection("skills")} className="text-fourth-color  flex">
                <Diagram3 size={22} />
                <span className="ml-2">Skills</span>
              </button>
            </li>
            <li>
              <button onClick={() => scrollToSection("portfolio")} className="text-fourth-color flex">
                <FileText size={21} />
                <span className="ml-2">Portfolio</span>
              </button>
            </li>
            <li>
              <button onClick={() => scrollToSection("contact")} className="text-fourth-color flex">
                <Envelope size={20} />
